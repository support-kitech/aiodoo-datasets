...
def test_version_resolver_valid_mappings():
    ...
    c1 = RepositoryConfiguration("community-17", RepositoryType.COMMUNITY, OdooVersion.V17, Path("a"), ())
    c2 = RepositoryConfiguration("enterprise-17", RepositoryType.ENTERPRISE, OdooVersion.V17, Path("b"), ())
    c3 = RepositoryConfiguration("community-18", RepositoryType.COMMUNITY, OdooVersion.V18, Path("c"), ())
