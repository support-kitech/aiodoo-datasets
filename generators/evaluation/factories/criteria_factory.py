...
class CriteriaFactory:
    ...
    @staticmethod
    def create_success(case_id: str, sequence_index: int, description: str, weight: float) -> SuccessCriteria:
    ...
    @staticmethod
    def create_failure(case_id: str, sequence_index: int, description: str, fatal: bool) -> FailureCriteria:
