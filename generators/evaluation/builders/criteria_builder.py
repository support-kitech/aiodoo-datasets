...
class CriteriaBuilder:
    ...
    def build_success(
        ...
        return CriteriaFactory.create_success(
            case_id=case_id, sequence_index=sequence_index, description=description, weight=weight
        )
    ...
    def build_failure(
        ...
        return CriteriaFactory.create_failure(
            case_id=case_id, sequence_index=sequence_index, description=description, fatal=fatal
        )
