...
class TestProtocol(unittest.TestCase):
    ...
    def test_protocol_equality_and_hashing(self):
        ...
        a1 = ProtocolArtifact(node_id="n1", name="a", type=ProtocolNodeType.MODEL, module="m", path="p", language=ProtocolLanguage.PYTHON, start_line=1, end_line=2, score=100, ranking_reason=ProtocolRankingReason.DIRECT_DEFINITION)
        a2 = ProtocolArtifact(node_id="n1", name="b", type=ProtocolNodeType.FIELD, module="m2", path="p2", language=ProtocolLanguage.XML, start_line=3, end_line=4, score=90, ranking_reason=ProtocolRankingReason.MODEL_INHERITANCE)
        a3 = ProtocolArtifact(node_id="n2", name="a", type=ProtocolNodeType.MODEL, module="m", path="p", language=ProtocolLanguage.PYTHON, start_line=1, end_line=2, score=100, ranking_reason=ProtocolRankingReason.DIRECT_DEFINITION)
