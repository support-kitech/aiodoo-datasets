...
class TestGraphBuilder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        logging.getLogger('aiodoo_datasets.generators.context.analysis.graph_builder').setLevel(logging.CRITICAL)
        
        self.graph = ContextGraph()
        self.node1 = ContextNode("model_a", "base", "a.py", NodeType.MODEL, LanguageType.PYTHON, start_line=1)
        self.node2 = ContextNode("field_b", "base", "a.py", NodeType.FIELD, LanguageType.PYTHON, start_line=5)
