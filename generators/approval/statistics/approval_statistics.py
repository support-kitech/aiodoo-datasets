...
class ApprovalStatistics:
    ...
    @staticmethod
    def compile(review: Review, rule_set: RuleSet, evidence_pool: Tuple[Evidence, ...]) -> Mapping[str, Any]:
        ...
        return MappingProxyType({
            ...
            "changes_requested": 1 if review.decision.status.value == "CHANGES_REQUESTED" else 0,
