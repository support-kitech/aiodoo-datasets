...
def build_artifacts(module: OdooModule, scenario: Scenario, py_k: PythonKnowledge, xml_k: XMLKnowledge) -> list[GeneratedArtifact]:
    """
    ...
    # Include manifest
    manifest_path = "__manifest__.py" if (module.path / "__manifest__.py").exists() else "__openerp__.py"
