...
class DummyAnalyzer1(BaseAnalyzer):
    PRIORITY = 10
    def analyze(self, context: AnalysisContext): pass
...
class TestAnalyzerRegistry(unittest.TestCase):
    ...
    @patch("aiodoo_datasets.generators.execution.registries.analyzer_registry._REGISTERED_ANALYZERS", (DummyAnalyzer1, DummyAnalyzer2))
    ...
    @patch("aiodoo_datasets.generators.execution.registries.analyzer_registry._REGISTERED_ANALYZERS", (DummyAnalyzer3,))
