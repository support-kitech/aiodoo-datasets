...
class MessageBuilder:
    ...
    @staticmethod
    def build(role: Role, content: str, turn_id: str, sequence_index: int, references: Tuple[Reference, ...] = ()) -> Message:
        return MessageFactory.create(role=role, content=content, turn_id=turn_id, sequence_index=sequence_index, references=references)
